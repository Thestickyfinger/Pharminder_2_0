...
public class NotesDbAdapter {
    ...
    public long createNoteFromGuardar(String title, String pactivo, String prescripcion, String viadministracion) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_TITLE, title);
        initialValues.put(KEY_BODY, pactivo);
    ...
    public boolean updateNoteFromGuardar(long rowId, String title, String body, String prescripcion, String viadministracion) {
        ContentValues args = new ContentValues();
        args.put(KEY_TITLE, title);
        args.put(KEY_BODY, body);
...
public class NotesDbAdapter {
    ...
    *//**
     ...
     *
     * @param title the title of the note
     * @param pactivo the body of the note
     * @param prescripcion necesita prescripcion medica o no
     * @param viadministracion la via de administracion
     * @return rowId or -1 if failed
     *//*
    public long createNote(String title, String pactivo, String prescripcion, String viadministracion) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_TITLE, title);
        initialValues.put(KEY_BODY, pactivo);
        initialValues.put(KEY_PRESCRIPCION,prescripcion);
